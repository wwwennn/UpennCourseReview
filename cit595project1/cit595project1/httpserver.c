...
void* handle_request(void* p) {
    ...
    strcpy(reply, prefix);
    if (strcmp(link, "avg_quality") == 0) strcat(reply, number1);
    strcat(reply, min_course_difficulty);
    if (strcmp(link, "min_difficulty") == 0) strcat(reply, number2);
